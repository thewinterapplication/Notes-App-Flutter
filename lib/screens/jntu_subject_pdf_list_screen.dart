...
/// Screen to display JNTU syllabus PDF files for a specific subject within a course.
...
class JntuSubjectPdfListScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<JntuSubjectPdfListScreen> createState() => _JntuSubjectPdfListScreenState();
}

class _JntuSubjectPdfListScreenState extends ConsumerState<JntuSubjectPdfListScreen> {
              ...
              child: pdfFilesAsync.when(
                ...
                error: (error, stack) => Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () => ref.invalidate(jntuFilesByCourseSubjectProvider(params)),
                ...
                data: (files) {
                  ...
                  return RefreshIndicator(
                    onRefresh: () async {
                      ref.invalidate(jntuFilesByCourseSubjectProvider(params));
                    },
