...
class JntuSubjectsScreen extends ConsumerStatefulWidget {
  ...
  const JntuSubjectsScreen({super.key, required this.course});
...
class _JntuSubjectsScreenState extends ConsumerState<JntuSubjectsScreen> {
  ...
  Widget build(BuildContext context) {
    final subjectsAsync = ref.watch(jntuSubjectsProvider(course.abbreviation));
              ...
              child: subjectsAsync.when(
                ...
                error: (error, stack) => Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () => ref.invalidate(jntuSubjectsProvider(course.abbreviation)),
                ...
                data: (subjects) {
                  ...
                  return RefreshIndicator(
                    onRefresh: () async {
                      ref.invalidate(jntuSubjectsProvider(course.abbreviation));
                    },
