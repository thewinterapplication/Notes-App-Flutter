...
/// Screen for uploading JNTU syllabus PDF notes.
/// Mirrors [UploadNotesScreen] but posts to the JNTU upload endpoint.
class UploadJntuNotesScreen extends StatefulWidget {
  const UploadJntuNotesScreen({super.key});

  @override
  State<UploadJntuNotesScreen> createState() => _UploadJntuNotesScreenState();
}
